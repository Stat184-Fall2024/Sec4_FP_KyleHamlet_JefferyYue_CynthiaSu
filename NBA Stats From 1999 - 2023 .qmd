...
We will be researching about the correlation between the 3-point goal percentage (3P%) and free throw goal percentage (FT%). These two attributes are part of dataset.
...
This figure has a more aggresive negative concave to it. Like previously we see that at age 39 and 44 there is a large spike in average assists per game.
...
From looking at the above visuals we can conclude that generally speaking players in their mid 20's to mid 30's perform the best in all 3 aspects. We can see there are some outliers amongst all 3 visuals occuring at the age 39 and higher. Due to the negative concavity, we can conclude that the general body of players start out with lower stats, progress to peak throughout the middle of their career, then decrease in performance as they are about to retire.
